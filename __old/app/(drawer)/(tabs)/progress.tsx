  ...
  return (
    <>
      <Header
        ...
        leftComponent={<Avatar src={require('@/assets/_global/img/user-3.jpg')} size="sm" link="/screens/profile" />}
      ...
      <ThemedScroller className="flex-1 !px-0">
        ...
        <View className='px-global mt-4'>
          ...
          <ProgressCard day='Wednesday, 18 June' weight='75.2' photo={require('@/assets/_global/img/progress.png')} />
          <ProgressCard day='Tuesday, 17 June' weight='75.2' photo={require('@/assets/_global/img/progress-2.png')} />
          <ProgressCard day='Monday, 16 June' weight='75.2' photo={require('@/assets/_global/img/progress-2.png')} />
          <ProgressCard day='Sunday, 15 June' weight='75.2' photo={require('@/assets/_global/img/progress-2.png')} />
