export default {
  ...
  tenantSelection: {
    ...
    scanDescription: 'Spor salonunuzdaki veya e-posta ile aldığınız herhangi bir QR kodunu tarayın',
    scanQrCode: 'QR Kodu Tara',
    tapToScan: 'Taramak için dokunun',
    useNfcInstead: 'NFC',
    enterManually: 'Manuel giriş',
    manualTitle: 'Salon ID girin',
    manualSubtitle: 'Spor salonu tanımlayıcınızı girin',
    connect: 'Bağlan',
    nfcTitle: 'NFC Etiketi Tara',
    nfcSubtitle: 'Telefonunuzu spor salonunuzdaki NFC etiketine yaklaştırın',
    nfcRetry: 'Tekrar Tara',
    label: 'Spor Salonu Tanımlayıcı',
    placeholder: 'örn: evolve',
    help: 'QR kodu için spor salonunuza sorun',
    // QR Scanner
    scanTitle: 'QR Kodu Tara',
    scanSubtitle: 'Kameranızı spor salonunuzun QR koduna doğrultun',
    noQrCode: 'QR kodunuz yok mu?',
    scanInstead: 'QR kodu tara',
    permissionRequired: 'Kamera İzni Gerekli',
    permissionMessage: 'QR kodlarını taramak için lütfen kamera erişimine izin verin',
    ...
    errors: {
      ...
      invalidQr: 'Geçersiz QR kodu. Lütfen geçerli bir spor salonu QR kodu tarayın.',
    },
  },
