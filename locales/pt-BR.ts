export default {
  ...
  tenantSelection: {
    ...
    scanDescription: 'Escaneie qualquer QR code na sua academia ou que você recebeu por e-mail',
    scanQrCode: 'Escanear QR Code',
    tapToScan: 'Toque para escanear',
    useNfcInstead: 'NFC',
    enterManually: 'Digitar manualmente',
    manualTitle: 'Digite o ID',
    manualSubtitle: 'Digite o identificador da sua academia',
    connect: 'Conectar',
    nfcTitle: 'Escanear Tag NFC',
    nfcSubtitle: 'Aproxime seu celular da tag NFC na sua academia',
    nfcRetry: 'Escanear Novamente',
    label: 'Identificador',
    placeholder: 'ex: evolve',
    help: 'Pergunte à sua academia pelo QR code',
    // QR Scanner
