export default {
  ...
  tenantSelection: {
    ...
    scanDescription: 'Scanne einen QR-Code in deinem Gym oder den du per E-Mail erhalten hast',
    scanQrCode: 'QR-Code scannen',
    tapToScan: 'Tippen zum Scannen',
    useNfcInstead: 'NFC',
    enterManually: 'Manuell eingeben',
    manualTitle: 'Gym-ID eingeben',
    manualSubtitle: 'Gib die Kennung deines Gyms ein',
    connect: 'Verbinden',
    nfcTitle: 'NFC-Tag scannen',
    nfcSubtitle: 'Halte dein Handy an den NFC-Tag in deinem Gym',
    nfcRetry: 'Erneut scannen',
    label: 'Gym-Kennung',
    placeholder: 'z.B. evolve',
    help: 'Frag dein Gym nach dem QR-Code',
    // QR-Scanner
